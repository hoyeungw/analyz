...
class Crostab {
  ...
  map(fn) {
    return Crostab.build(this.side.slice(), this.head.slice(), matrixMapper.mapper(this.rows, fn), this.title);
  }
  ...
  slice() {
    return Crostab.build(this.side.slice(), this.head.slice(), matrixInit.shallow(this.rows), this.title);
  }
