...
const { indexesOf, indexesAt } = Labels.prototype;
...
class XMappable {
  ...
  mutateKeys(fn) { return mutate(this.side, fn), this }
  mutateAt(x, fn) {
...
class YMappable {
  ...
  mutateKeys(fn) { return mutate(this.head, fn), this }
  mutateValues(fn) { return mutate$1(this.rows, fn), this }
  ...
  * indexed(by, to) { yield* indexed$1(this.rows, by, to); }
  ...
  * indexedTo(to) { yield* indexedTo$1(this.rows, to); }
